...
public class ProductController {
	...
	public CommonMatchData evolution6() {
		return new CommonMatchData("evolution6-2");
	}
	
	@GetMapping(value = "/product/evolution7", produces = "application/json")
	@ResponseBody
	public CommonMatchData evolution7() {
		return new CommonMatchData("evolution7-2");
	}
	
	@GetMapping(value = "/product/evolution8", produces = "application/json")
	@ResponseBody
	public CommonMatchData evolution8() {
		return new CommonMatchData("evolution8-2");
	}
	...
	@GetMapping(value = "/product/evolution10", produces = "application/json")
	@ResponseBody
	public CommonMatchData evolution10() {
		return new CommonMatchData("evolution10-3");
	}
	
	@GetMapping(value = "/product/evolution11", produces = "application/json")
	@ResponseBody
	public CommonMatchData evolution11() {
		return new CommonMatchData("evolution11-3");
	}
}
